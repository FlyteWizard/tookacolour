        ...
        <nav className="navbar navbar-expand-md navbar-light bg-beige">
          ...
          <div className="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div className="navbar-nav">
              ...
              <a className="nav-item nav-link" rel="noopener noreferrer" target="_blank" href="https://github.com/FlyteWizard/tookacolour"><i className="fas fa-book"><span className="sr-only">Book Icon</span></i>Documentation</a>
